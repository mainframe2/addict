defmodule Addict.ManagerInteractorTest do
  ...
  #   assert Interactor.create(user_params, RepoStub, MailerStub, PasswordInteractorStub) ==
  ...
  #   assert catch_throw(Interactor.create(user_params, RepoStub, MailerStub)) ==
  #            "Unable to create user, invalid hash. Required params: email, password, username"
  # end
  ...
  #   assert Interactor.recover_password(email, RepoNoMailStub, MailerStub) ==
  #            {:error, "Unable to send recovery e-mail"}
  # end

  # test "resets password" do
  #   assert Interactor.reset_password("token123", "valid_password", "valid_password", RepoStub, PasswordInteractorStub)
  #            == {:ok, %{email: "test@example.com"}}
  # end
  ...
  #   assert Interactor.reset_password("invalidtoken", "password", "password", RepoStub) ==
  #            {:error, "invalid recovery hash"}
  # end

  # test "handles reset password with invalid password confirmation" do
  #   assert Interactor.reset_password("invalidtoken", "password", "password_invalid") ==
