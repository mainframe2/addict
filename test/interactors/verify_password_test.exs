defmodule VerifyPasswordTest do
  ...
  test "it validates correct passwords" do
    user = %TestAddictSchema{
      encrypted_password:
        "$pbkdf2-sha512$100000$od8q.7wWyoUzThxnm7mnHQ$kW4PEzo9l/f.emd5khI3EhpjQaLMKecCTl3YrPNglhYNzCtyfmaggCtHWDpM7MS/Kv4eewwl12HbcHiMn3nnPg"
    }
